...
class FirebaseClientHelper {
  ...
  static onSignInError(error) {
    ...
    document.querySelector(".login_error_message").innerText = "Sign In Error. Try again."
  }
    ...
    return {
      callbacks: {
        ...
        uiShown: () => {
          ...
          let googleIconBasePath = "/assets/images/backgrounds/google_white_icon.png"
  ...
  static onIdTokenChanged(cb) {
    firebase.auth().onIdTokenChanged(cb)
  }

  static fetchFirebaseIdToken(user, cb) {
